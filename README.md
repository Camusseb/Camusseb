...
Un script d'automatisation est disponible:
...
Cliquez sur **Lancer l’aperçu démo** dans l'application pour préremplir un scénario d'audit faible maturité et afficher directement le rapport final.


## Exploitation

- Reverse proxy Nginx: `deploy/nginx/default.conf`
