...
function runDemoPreview() {
  Object.assign(session, {
    organisation: 'MonOrg',
    secteur: 'PME',
    tailleEquipe: '20',
    defi: 'Standardiser les process',
    charteIA: 'non',
    referentIA: 'non',
    cadreRGPD: 'non',
    ...
    kpiIA: 'non',
    roadmapIA: 'non',
    risques: ['Gouvernance faible', 'Risque conformité RGPD', 'Shadow AI actif'],
  });

  renderReport();
  addMessage('Aperçu démo chargé ✅', 'agent');
}
...
if (runDemoBtn) {
  runDemoBtn.addEventListener('click', runDemoPreview);
}
